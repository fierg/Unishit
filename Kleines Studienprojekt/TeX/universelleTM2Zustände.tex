...
\end{center}
	...
	Beweis per Kontraposition von Schannon:\\
	...
	\pause Beweishilfe: \enquote{\textit{reflection number}}\\
	...
	\begin{itemize}
	\pause \item $||\underbrace{A_1}|A_2|...|A_m|A_x|\Square|\Square|...$
	\end{itemize}
	...
	\end{itemize}
	\end{itemize}
	\visible<7->{\item $2.3$ $R \leq S$}
	\begin{itemize}
	\visible<8->{\item $2.3.1$ Lesekopf verlässt erstes leere Feld nach Links}
	\visible<9->{\item $2.3.2$ Lesekopf verlässt erstes leeres Feld $R$ mal nach rechts}
	\begin{itemize}
	\visible<10->{\item $2.3.2.1$ $R<S$ Lesekopf auf erstem $\Square$ gefangen}
	\visible<11->{\item $2.3.2.2$ $R=S$ }
	\end{itemize}
	\end{itemize}
	\end{itemize}
	...
	\only<7-10>{$2.3$ Lesekopf betritt ursprünglich unbeschriebenen Bereich des Bandes und bleibt dort\\}
	...
	\section{äquivalente Turingmaschine mit nur zwei Symbolen}
...
\bigskip
	...
	\only<1>{$...|\overbrace{\underbrace{1}|1|\Square|1|\Square|...}^{\text{l Felder lang}}|1|\Square|...$}
...
\end{tikzpicture}
	...
	Shannon endet das Paper mit der Fragestellung:\\
	 ...
	 \bigskip
	 \begin{itemize}
	 \pause \item Wolfram Alpha announced a 25,000 prize to be won by the first person to prove or disprove the universality of the (2,3) Turing machine
	 \pause \item On 24 October 2007, it was announced that the prize had been won by Alex Smith, a student in electronics and computing at the University of Birmingham, for his proof that it was universal
	 \end{itemize}
