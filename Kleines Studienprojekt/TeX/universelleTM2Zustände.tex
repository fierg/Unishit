...
\end{center}
	...
	\visible<9->{\item $2.3.2$ Lesekopf verlässt erstes leere Feld $R$ mal nach rechts}
	\begin{itemize}
...
\end{tikzpicture}
	...
	Shannon endet das Paper mit der Fragestellung:\\
	 ...
	 \item Am 24 October 2007 wurde bekanntgegeben, dass Alex Smith, Student bei der University of Birmingham, die Universalität der (2,3) TM bewiesen hat.
	 \end{itemize}
